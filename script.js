...
const fabrica = {
  ...
  opcoes: ["feijao","milho","ervilha","sardinhas","pessego","fiat-uno","boeing-747"],
...
function coloca_latas_na_tela() {
  for(let lata of fabrica.latas){
    ...
    comidaSpan.innerText = fabrica.seleciona_opcao_aleatoria();
    lata.elemento.className = comidaSpan.innerText;
